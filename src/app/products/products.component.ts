 ...
 ProductList: any[];
  constructor() {
    this.ProductList = [
      ...
      { id: 700, name: 'apple S22 Utlra', price: 500, quantity: 4, imgURL: 'https://fakeimg.pl/200x100', categoryID: 4 },
      { id: 800, name: 'tochiba Utlra', price: 60000, quantity: 14, imgURL: 'https://fakeimg.pl/200x100', categoryID: 4 },
      { id: 900, name: 'ththt Utlra', price: 60, quantity: 0, imgURL: 'https://fakeimg.pl/200x100', categoryID: 4 },
    ]
  }
  allProduct(): any[] {
